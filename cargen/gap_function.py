...
def get_gap_cartilage(vertices_p,
    ...
    # viz
    frame = mp.plot(vertices_s, faces_s, c=cargen.bone, shading=cargen.sh_false)
    frame.add_mesh(vertices_p, faces_p[base_face_idxs], c=cargen.pastel_blue, shading=cargen.sh_true)
    ...
    # geometry
    print("sacroiliac cartilage base area is: ", np.round(cartilage_area, 2))
    print("mean sacroiliac cartilage thickness is: ", np.round(np.mean(thickness_profile[base_vertex_idxs]), 2))
    print("maximum sacroiliac cartilage thickness is: ", np.round(np.max(thickness_profile[base_vertex_idxs]), 2))
