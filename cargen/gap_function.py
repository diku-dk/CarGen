...
def get_gap_cartilage(vertices_p,
                      faces_p,
                      vertices_s,
                      faces_s,
                      param):
    ...
    frame.add_mesh(vertices_p, faces_p[base_face_idxs], c=cargen.pastel_blue, shading=cargen.sh_true)
    ...
    if len(folded_vertex_idxs) != 0:
        ...
        # vz
        print("faulty vertices & neighbouring triangles:")
        frame = mp.plot(ex_vertices_p, faces_p[ex_base_face_idxs], c=cargen.pastel_blue, shading=cargen.sh_false)
    ...
    frame.add_mesh(vertices_bs, faces_s, c=cargen.bone, shading=cargen.sh_false)
    frame.add_mesh(vertices_p, faces_p[base_face_idxs], c=cargen.pastel_blue, shading=cargen.sh_true)
    frame.add_mesh(ex_vertices_p, faces_p[ex_base_face_idxs], c=cargen.pastel_green, shading=cargen.sh_true)
    ...
    # viz
    frame = mp.plot(ex_vertices_p, faces_p[base_face_idxs], c=cargen.pastel_green, shading=cargen.sh_true)
    frame.add_mesh(vertices_p, base_faces, c=cargen.pastel_blue, shading=cargen.sh_true)
    frame.add_mesh(roof_vertices, roof_faces, c=cargen.pastel_orange, shading=cargen.sh_true)
    ...
    f = mp.plot(roof_vertices, roof_faces, c=cargen.pastel_orange, shading=cargen.sh_true)
    f.add_mesh(vertices_s, faces_s, c=cargen.bone, shading=cargen.sh_false)

    frame = mp.plot(vertices_p, faces_p, c=cargen.bone, shading=cargen.sh_false)
    frame.add_mesh(usi_vertices, usi_faces, c=cargen.pastel_orange, shading=cargen.sh_true)

    # geometry
    print("cartilage base area is: ", np.round(cartilage_area, 2))
    print("mean cartilage thickness is: ", np.round(np.mean(thickness_profile[base_vertex_idxs]), 2))
    print("maximum cartilage thickness is: ", np.round(np.max(thickness_profile[base_vertex_idxs]), 2))
